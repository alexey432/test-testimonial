...
var SkhemataTestimonial = /*#__PURE__*/function (_SkhemataBase) {
  ...
  var _super = _createSuper(SkhemataTestimonial);

  function SkhemataTestimonial() {
    var _this;

    _classCallCheck(this, SkhemataTestimonial);

    _this = _super.apply(this, arguments); // Component specific properties

    _this.carouselInterval = 5000;
    _this.activeTestimonial = 0;
    /**
     * Click function for carousel dots
     * */

    _this.handleCarouselDotClick = function (event) {
      event.preventDefault();
      var elementId = event.target.value;

      _this.makeActive(elementId);
    };
    /**
    ...
    _this.makeActive = function (elementId) {
      _this.activeTestimonial = parseInt(elementId.substring(elementId.length - 1, elementId.length), 10);

      if (_this.shadowRoot) {
        var selectedElement = _this.shadowRoot.querySelector(elementId);

        var carouselElement = _this.shadowRoot.querySelector('.testimonials-carousel');

        if (carouselElement !== null) {
          carouselElement.scroll(carouselElement.clientWidth * _this.activeTestimonial, 0);
        } // Add/remove class from slide elements


        var carouselItems = _this.shadowRoot.querySelectorAll('.testimonial-item');
        ...
        var carouselDots = _this.shadowRoot.querySelectorAll('.carousel-dots li');

        for (var _index = 0; _index < carouselDots.length; _index += 1) {
          // Remove is-active from all elements
          if (_index === _this.activeTestimonial) {
    ...
    _this.carouselItem = function () {
      ...
      return T(_templateObject$1 || (_templateObject$1 = _taggedTemplateLiteral(["\n    <div class=\"testimonials-carousel\">\n      ", "\n    </div>\n  "])), testimonials.map(function (testimonial, index) {
        return T(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n          <div\n            class=\"testimonial-item ", "\"\n            id=\"slide-", "\"\n          >\n            <div class=\"flex-card card-overflow raised\">\n              <div class=\"testimonial-avatar\">\n                ", "\n              </div>\n              <div class=\"testimonial-name\">\n                <h3 class=\"title is-4\">", "</h3>\n              </div>\n              <div class=\"testimonial-content\">\n                <fa-icon class=\"quote\" .icon=", "></fa-icon>\n                ", "\n              </div>\n            </div>\n          </div>\n        "])), index === 0 ? 'is-active' : '', index, testimonial.avatar ? T(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n                      <img\n                        src=\"", "\"\n                        alt=\"", "\"\n                      />\n                    "])), testimonial.avatar, testimonial.name) : T(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n                      <div class=\"testimonial-avatar-placeholder\">\n                        <fa-icon\n                          class=\"avatar-placeholder\"\n                          .icon=", "\n                        ></fa-icon>\n                      </div>\n                    "])), faUser), testimonial.name, faQuoteLeft, stringToHtml(testimonial.comment));
      }));
    };
    /**
    ...
    _this.carouselDots = function () {
      var data = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
      return T(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n    <ul class=\"carousel-dots\">\n      ", "\n    </u>\n  "])), data.map(function (_data, index) {
        return T(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n          <li class=\"", "\">\n            <button\n              value=\"#slide-", "\"\n              @click=", "\n            ></button>\n          </li>\n        "])), index === 0 ? 'is-active' : '', index, _this.handleCarouselDotClick);
      }));
    };
  ...
  _createClass(SkhemataTestimonial, [{
    key: "firstUpdated",
    value: function () {
              ...
              case 2:
                if (((_a = this.configData) === null || _a === void 0 ? void 0 : _a.length) && this.carouselInterval > 0) {
                  setInterval(function () {
                    _this2.activeTestimonial = (_this2.activeTestimonial + 1) % _this2.configData.length;

                    _this2.makeActive("#slide-".concat(_this2.activeTestimonial));
    ...
    key: "styles",
    get: function get() {
      return [].concat(_toConsumableArray(_get(_getPrototypeOf(SkhemataTestimonial), "styles", this)), [SkhemataTestimonialStyle]);
    }
  }]);
